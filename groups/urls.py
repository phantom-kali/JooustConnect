...
urlpatterns = [
    ...
    path(
        "<int:group_id>/manage-requests/",
        views.manage_group_requests,
        name="manage_group_requests",
    ),
    ...
    path(
        "poll-group-messages/<int:group_id>/",
        views.poll_group_messages,
    ...
    path(
        "<int:group_id>/remove-member/<int:user_id>/",
        views.remove_member,
        name="remove_member",
    ),
    path("<int:group_id>/invite/", views.invite_to_group, name="invite_to_group"),
    path(
        "redirect-to-group/<int:notification_id>/",
        views.redirect_to_group,
        name="redirect_to_group",
    ),
]
